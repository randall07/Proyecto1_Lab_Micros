...
;finalmente, se calcula el modelo extendido del procesador
                        ...
                        impr_texto cons_hex_header,cons_tam_hex_header
                                                ;Se recuperan los valores de CPUID
                        mov rax,r8
                                                ;Para poder trabajar el 6to nibble, es necesario hacer un corrimiento a RAX
                                                ;antes de procesarlo con las mascaras en EDX
                        shr rax,8
                        mov edx,eax
                                                ;Nos interesa el cuarto nibble de EDX (Modelo Ext) - Se filtra con una mascara
...
; se calcula el Brand id del procesador
			...
			mov ebx,1
                        ...
                        impr_texto cons_hex_header,cons_tam_hex_header
                                                ;Se recuperan los valores de CPUID
                        mov rax,r8
                                                ;Para poder trabajar el 1er nibble, es necesario hacer un corrimiento a RAX
                                                ;antes de procesarlo con las mascaras en EDX
                       ;shr rax,8
                        mov edx,ebx
                                                ;Nos interesa el cuarto nibble de EDX (Modelo Ext) - Se filtra con una mascara
